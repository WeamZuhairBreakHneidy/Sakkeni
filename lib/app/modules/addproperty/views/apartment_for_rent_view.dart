...
class ApartmentForRentView extends GetView<AddpropertyController> {
        ...
        case 0: // For Rent
          return _buildForm(
            ...
            [
              controller.priceController,
              controller.leasePeriodController,
              controller.paymentPalController,       // بدلًا من officeAreaController
              controller.furnishingController,        // بدلًا من officeFurnishedController
              controller.floorNumberRentController,
              controller.buildingNumberRentController,
              controller.apartmentNumberRentController,
            ],
        ...
        case 1: // For Sale
          return _buildForm(
            ...
            [
              controller.priceController,
              controller.furnishingController,         // بدلًا من officeFurnishedController
              controller.floorNumberSaleController,    // بدلًا من officeMaintenanceController
              controller.buildingNumberSaleController,
              controller.apartmentNumberSaleController,
            ],
          );
  ...
  Widget _buildCheckCircle() => Container(
    width: 22.w,
    height: 22.w,
  ...
  Widget _buildStepCircle({required bool isFilled}) => Container(
    width: 20.w,
    height: 20.w,
    decoration: BoxDecoration(
  ...
  Widget _buildStepLine({required bool isFilled}) => Container(
    width: 20.w,
    height: 2.h,
    color: isFilled ? Color(0xFF294741) : Colors.grey.shade300,
