...
class Data {
  Data({
    ...
    required this.description, // تم تعديل النوع إلى String
  ...
  final String description; // تم تعديل النوع هنا أيضاً
  ...
  factory Data.fromJson(Map<String, dynamic> json) {
    return Data(
      ...
      coverImage: json["cover_image"] == null ? null : Image1.fromJson(json["cover_image"]),
    );
  }
...
class OffPlan {
  ...
  factory OffPlan.fromJson(Map<String, dynamic> json) {
    return OffPlan(
      ...
      createdAt: DateTime.tryParse(json["created_at"] ?? ""),
      updatedAt: DateTime.tryParse(json["updated_at"] ?? ""),
      paymentPhases: json["payment_phases"] == null
          ? []
          : List<AvailabilityStatus>.from(
